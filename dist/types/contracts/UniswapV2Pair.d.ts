...
export interface IUniswapV2PairEvents {
    Approval: (data: (Log & {
        args: IUniswapV2PairApprovalEventParams;
    })) => void;
    Burn: (data: (Log & {
        args: IUniswapV2PairBurnEventParams;
    })) => void;
    Mint: (data: (Log & {
        args: IUniswapV2PairMintEventParams;
    })) => void;
    Swap: (data: (Log & {
        args: IUniswapV2PairSwapEventParams;
    })) => void;
    Sync: (data: (Log & {
        args: IUniswapV2PairSyncEventParams;
    })) => void;
    Transfer: (data: (Log & {
        args: IUniswapV2PairTransferEventParams;
    })) => void;
}
